...
const teamMainTeckStack = ['Vue', 'Vuex', 'Vue-Router', 'Javascript', 'Webpack', 'Axios', 'SCSS', 'CSS']

const teamSubTeckStack = ['Next.js', 'React', 'Jotai']

const Career = () => {
    return (
        <div className="whitespace-pre-line py-4 text-sm sm:text-base">
            <DetailExperienceTitle  detailPeriod={'2021.08.02 ~ ( 재직중 )'} />
            ...
            <div className="pt-3 pb-8 text-sm sm:text-base">
                ...
                <br/><br/>
                결제선생의 <b>'청구서', '매니저 사이트', '어드민 사이트'</b> 등 여러 페이지에 대한 작업 경험이 있으며, 신규 서비스 개발, 기존 서비스 유지 보수, 운영 오류 처리 및 조치 등 다양한 업무를 경험했습니다. 특히 <b>어드민 사이트(Back Office)의 프론트엔드 개발을 주도</b>했습니다. 
                <br/><br/>
