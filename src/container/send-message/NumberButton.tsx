...
export default function NumberButton(props: ButtonProps) {
  ...
  return (
    <button
      className={`${props.className} active:text-red-500 active:rounded active:bg-gray-100 active:rounded-full`}
      onClick={
        props.buttonTargetNumber !== null
          ? () => clickNumber(props.buttonTargetNumber)
          : undefined
      }
    >
      {props.buttonTargetNumber !== null && props.buttonTargetNumber >= 0
