    ...
    <div>
      ...
      <div className="whitespace-pre-line px-1 py-3.5 text-sm sm:text-base">
        <p>
          ...
          <br />
          현재 <b>3년차</b> 프론트엔드로 재직중이며, 다양한 사람과의 소통을
          좋아합니다.
          <br />
          <br />
          솔직하고 담백한 화법을 선호하며, 동료들과의 논의를 통해 하나의 목표를
          이뤄 나가는 과정을 즐깁니다. 또한, 팀 개발자분들과 함께하는 리뷰
          시간을 중요하게 생각합니다. 저는 이러한 다양한{' '}
          <b>소통의 과정에서 얻는 배움</b>을 통해 성장해 나가고 있습니다.
          <br />
          <br />
          아래의 내용은 업무 과정에서 경험한{' '}
          <b>
