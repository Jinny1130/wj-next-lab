...
export const otherPageAbout: Record<string, WorkPageAbout> = {
  wjSendMessage: {
    period: '2024.05',
    pageAbout:
      'Next.js로의 마이그레이션을 위해 <b>사내 스터디를 진행</b>하며 제작한 사이드 프로젝트입니다. 이 프로젝트는 <b>Next.js</b> 프레임워크와 <b>AWS</b> 서비스에 대한 이해도를 높이는 데 초점을 두었습니다. 링크를 클릭하면 실제 메시지 발송이 가능한 페이지로 연결되며, <b>메시지 발송 및 수신</b> 과정을 직접 체험할 수 있습니다.',
  },
  readingOcean: {
    period: '',
    pageAbout:
      "(주)레듀텍 사의 '리딩오션' 서비스 내부의 유아의 독서 증진을 위한 동기부여 프로그램으로 <b>육성 시뮬레이션 게임</b>에 기반한 페이지입니다. 독서에 대한 흥미를 높여 유아의 지속적인 독서를 위한 <b>에듀케이션 프로그램</b>입니다.",
  },
};

export const detailOtherExperiences: Record<
  string,
  DetailWorkExperienceInfo[]
> = {
  wjSendMessage: [
