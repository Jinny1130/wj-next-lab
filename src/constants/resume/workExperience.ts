...
export const workPageAbout: Record<string, WorkPageAbout> = {
    ...
    manager: {
        period: "",
        pageAbout: "결제선생 <b>서비스 유저가 이용</b>하는 사이트로 사업장 등록, 청구서 관리 및 발송, 청구서 수신 고객 관리 등 여러가지의 기능을 제공합니다. 주로 다양한 서비스의 <b>프로세스 리뉴얼 및 기존 UI/UX 개선 작업</b>을 하였으며, 사용자 경험을 개선하기 위해 지속적으로 기능을 <b>업데이트 및 최적화</b>했습니다.",
    },
    ...
    other: [
        {
            ...
            projectSummary: '결제선생 및 출결선생의 핵심 기능인 <b>청구서와 출결 메시지 발송을 체험</b>할 수 있는 페이지로, 서비스 이용을 간접적으로 경험할 수 있습니다.',
            period: '2024.01',
            describe: [
