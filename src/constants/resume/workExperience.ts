    ...
    admin: [
      {
        ...
        period: '상시',
        describe: [
          '<b>GitLab 파이프라인</b>을 이용하여 <b>CI/CD</b>를 구현하기 위해 AWS <b>CloudFront와 S3</b>를 활용하여 빠르게 배포할 수 있도록 설정했습니다. Git에 push가 발생하면 파이프라인에 커밋이 축적되고, 해당 커밋에 대한 배포는 <b>수동 승인(Manual Trigger)</b> 방식으로 구성해, 배포 시작 버튼을 눌러야 실제 배포가 진행되도록 설정했습니다.',
